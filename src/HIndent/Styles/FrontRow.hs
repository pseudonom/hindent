...
-- | Stub module for Front Row's style.
--
-- Questions:
--
...
module HIndent.Styles.FrontRow where
...
frontRow :: Style
frontRow =
  Style {styleName = "front-row"
        ,styleAuthor = "Eric Easley"
        ,styleDescription = "Style modeled after Front Row's style guide"
